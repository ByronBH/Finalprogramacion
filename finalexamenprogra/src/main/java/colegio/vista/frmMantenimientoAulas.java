...
public class frmMantenimientoAulas extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<clsAulas> aulas = aulaDAO.select();
        tablaVendedores.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < aulas.size(); i++) {
            dato[0] = Integer.toString(aulas.get(i).getcodigo_aula());
            dato[1] = aulas.get(i).getnombre_aula();
            dato[2] = aulas.get(i).getestatus_aula();
    ...
    public void buscarVendedor() {
        clsAulas aulaAConsultar = new clsAulas();
        daoAula aulaDAO = new daoAula();
        aulaAConsultar.setcodigo_aula(Integer.parseInt(txtbuscado.getText()));
        aulaAConsultar = aulaDAO.query(aulaAConsultar);
        txtNombre.setText(aulaAConsultar.getnombre_aula());   
        cbox_estado.setSelectedItem(aulaAConsultar.getestatus_aula());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if ( i == 0){
        daoAula aulaDAO = new daoAula();
        clsAulas aulaAEliminar = new clsAulas();
        aulaAEliminar.setcodigo_aula(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daoAula aulaDAO = new daoAula();
        clsAulas aulaAInsertar = new clsAulas();
        aulaAInsertar.setnombre_aula(txtNombre.getText());
         aulaAInsertar.setestatus_aula(cbox_estado.getSelectedItem().toString());
...
//        // TODO add your handling code here:
  int i =JOptionPane.showConfirmDialog(this, "seguro que quieres modificar este dato ");
        if ( i == 0){
        daoAula aulaDAO = new daoAula();
        clsAulas aulaAActualizar = new clsAulas();
        aulaAActualizar.setcodigo_aula(Integer.parseInt(txtbuscado.getText()));
        aulaAActualizar.setnombre_aula(txtNombre.getText());
        aulaAActualizar.setestatus_aula(cbox_estado.getSelectedItem().toString());
