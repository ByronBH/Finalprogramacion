...
public class frmMantenimientoCarrera extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        daoCarrera carreraDAO = new daoCarrera();
        List<clsCarreras> carreras = carreraDAO.select();
    ...
    public void buscarVendedor() {
        clsCarreras carreraAConsultar = new clsCarreras();
        daoCarrera carreraDAO = new daoCarrera();
        ...
        txtNombre.setText(carreraAConsultar.getnombre_carrera());   
         txtCodigo.setText(carreraAConsultar.getcodigo_facultad()); 
        cbox_estado.setSelectedItem(carreraAConsultar.getestatus_carrera());
    ...
    private void initComponents() {
        ...
        getContentPane().add(label3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, -1, -1));
        ...
        getContentPane().add(cbox_estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 150, 200, 20));
        ...
        label4.setText("Codigo Facultad");
        label4.setToolTipText("En este apartado se agrega el nombre de los departamentos que tiene la empresa");
        getContentPane().add(label4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, -1, -1));
        ...
        getContentPane().add(txtCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 120, 200, -1));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daoCarrera carreraDAO = new daoCarrera();
        clsCarreras carreraAInsertar = new clsCarreras();
        carreraAInsertar.setnombre_carrera(txtNombre.getText());
          carreraAInsertar.setcodigo_facultad(txtCodigo.getText());
         carreraAInsertar.setestatus_carrera(cbox_estado.getSelectedItem().toString());
...
//        // TODO add your handling code here:
  int i =JOptionPane.showConfirmDialog(this, "seguro que quieres modificar este dato ");
        if ( i == 0){
        daoCarrera carreraDAO = new daoCarrera();
        clsCarreras carreraAActualizar = new clsCarreras();
        ...
        carreraAActualizar.setnombre_carrera(txtNombre.getText());
         carreraAActualizar.setcodigo_facultad(txtCodigo.getText());
        carreraAActualizar.setestatus_carrera(cbox_estado.getSelectedItem().toString());
