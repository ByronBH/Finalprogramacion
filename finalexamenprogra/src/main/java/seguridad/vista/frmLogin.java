...
import colegio.vista.mdiFacultad;
...
public class frmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbxAreas.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione:", "Area Seguridad", "Facultad" }));
            ...
            try {
                ...
                if (txtContraseña.getText().equals(usuarioAConsultar.getUsucontrasena()) && txtUsuario.getText().equals(usuarioAConsultar.getUsunombre())) {
                    ...
                    switch (areaSeleccionada) {
                        ...
                        case "Facultad":
                        try {
                            mdiFacultad menuSeguridad = new mdiFacultad();
                            menuSeguridad.setVisible(true);
                            this.dispose();
                        } catch (Exception e) {
                            System.out.println(e);
